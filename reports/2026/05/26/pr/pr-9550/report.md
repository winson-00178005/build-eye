...
pr_number: 9550
group_key: pr-9550
generated_at: 2026-05-26T03:34:40.722637+00:00
...
PR #9550 触发了 5 个 workflow，均失败。

- **代码问题**: 5 次

| # | Workflow | 根因分类 | 置信度 | 具体问题 |
|---|---|---|---|---|
| 1 | E2E-Light (#26429159872) | PR代码问题 | 高 | 编译错误 |
| 2 | E2E-Light (#26428815543) | PR代码问题 | 高 | 编译错误 |
| 3 | E2E-Light (#26428598281) | PR代码问题 | 高 | 编译错误 |
| 4 | E2E-Light (#26428262010) | PR代码问题 | 高 | 编译错误 |
| 5 | E2E-Light (#26427920739) | PR代码问题 | 高 | 编译错误 |


## Workflow 详细分析
### 1. E2E-Light (Run #26429159872)
...
[查看 Workflow Run](https://github.com/vllm-project/vllm-ascend/actions/runs/26429159872)
[查看 Job: smart test (d4004455d2357985830af10e432709b42c820455) / smart-ut (cpu x0)](https://github.com/vllm-project/vllm-ascend/actions/runs/26429159872/job/77798963377)

**日志片段**:
```
2026-05-26T02:54:06.7608506Z         Solution: 1.Check the input parameter range of the function. 2.Check the function invocation relationship.
2026-05-26T02:54:06.7609006Z         TraceBack (most recent call last):
2026-05-26T02:54:06.7609398Z         [Init][Version]init soc version failed.[FUNC:ReportInnerError][FILE:log_inner.cpp][LINE:132]
2026-05-26T02:54:06.7609956Z         chipType=0 does not support get device msg feature.[FUNC:GetDevMsg][FILE:api_impl.cc][LINE:6181]
2026-05-26T02:54:06.
```
...
- **E2E-Light (#26429159872)**: 检查编译错误位置 (低成本) - 查看 CMake 或 clang 报错的具体文件和行
...
---
报告生成时间: 2026-05-26T03:34:40.722707+00:00
