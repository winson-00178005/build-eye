...
report_id: f3b3a386
pr_number: null
group_key: run-30360309769
generated_at: 2026-07-28T22:59:09.225151+00:00
...
# 构建失败报告: run-30360309769

## 概要

run-30360309769 触发了 1 个 workflow，均失败。

- **代码问题**: 1 次

| # | Workflow | 根因分类 | 置信度 | 具体问题 |
|---|---|---|---|---|
| 1 | Docs link check (#30360309769) | PR代码问题 | 高 | 编译错误 |


## Workflow 详细分析
### 1. Docs link check (Run #30360309769)
...
---
报告生成时间: 2026-07-28T22:59:09.225184+00:00
