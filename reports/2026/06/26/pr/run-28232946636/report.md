...
report_id: c622fa5e
pr_number: null
group_key: run-28232946636
generated_at: 2026-06-26T12:15:01.766736+00:00
...
# 构建失败报告: run-28232946636

## 概要

run-28232946636 触发了 1 个 workflow，均失败。

- **代码问题**: 1 次

| # | Workflow | 根因分类 | 置信度 | 具体问题 |
|---|---|---|---|---|
| 1 | Docs link check (#28232946636) | PR代码问题 | 高 | 编译错误 |


## Workflow 详细分析
### 1. Docs link check (Run #28232946636)
...
---
报告生成时间: 2026-06-26T12:15:01.766752+00:00
