...
pr_number: 10490
group_key: pr-10490
generated_at: 2026-06-15T10:27:17.185321+00:00
...
PR #10490 触发了 1 个 workflow，均失败。

- **代码问题**: 1 次

| # | Workflow | 根因分类 | 置信度 | 具体问题 |
|---|---|---|---|---|
| 1 | E2E-upstream (#27538823854) | PR代码问题 | 中 | 编译错误 |
...
**分析推理**: 检测到代码问题模式: compilation。 问题出现在 PR #10490 代码中。 建议检查 PR 的代码修改和测试用例。
...
---
报告生成时间: 2026-06-15T10:27:17.185366+00:00
